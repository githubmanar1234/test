...
class ValidatorHelper
{
    ...
    public static function messages()
    {
        $messages = [
            ...
            'location.regex' => 'The :attribute must be a valid set of latitude and longitude coordinates, with a limit of 8 digits after a decimal point',
            'details.location.regex' => 'The :attribute must be a valid set of latitude and longitude coordinates, with a limit of 8 digits after a decimal point',
            'languages' => 'the :attribute must have all supported languages (ar, en, fr)',
        ];
        return $messages;
    }
